...
--
-- Host: localhost    Database: db_paulistense
-- ------------------------------------------------------
-- Server version	8.0.33
USE `sys`;

CREATE USER 'user_teste'@'%' IDENTIFIED BY '9e9f4fd45db1fa6f894aec0f3929a05c'; 
CREATE USER 'user_teste'@'localhost' IDENTIFIED BY '9e9f4fd45db1fa6f894aec0f3929a05c'; 

GRANT ALL PRIVILEGES ON *.* TO 'user_teste'@'%';
GRANT ALL PRIVILEGES ON *.* TO 'user_teste'@'localhost';

CREATE DATABASE IF NOT EXISTS `db_paulistense`;
USE `db_paulistense`;
...
INSERT INTO `contatos` VALUES (7,'Contato de usuário padrão.',NULL,NULL,NULL,'1@gmail.com',NULL,NULL,NULL,1,'Contato de usuário padrão.',NULL),(10,'Funcionário vinculado a usuário existente','','','','funcionario@funcionario.com','','',NULL,1,'Funcionário vinculado a usuário existente',2),(11,'Funcionário vinculado a usuário existente','','','','1@1.com','','',NULL,1,'Funcionário vinculado a usuário existente',2),(14,'Contato de usuário padrão.',NULL,NULL,NULL,'geversonjosedesouza@hotmail.com',NULL,NULL,NULL,1,'Contato de usuário padrão.',NULL),(15,'Contato de usuário padrão.',NULL,NULL,NULL,'geversonjosedesouza@hotmail.com',NULL,NULL,NULL,1,'Contato de usuário padrão.',NULL);
...
CREATE TABLE `enderecos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `logradouro` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
...
INSERT INTO `enderecos` VALUES (47,NULL,NULL,NULL,NULL,1,NULL,2),(48,NULL,NULL,NULL,NULL,1,NULL,2),(50,'2','1','1','1',1,950,2),(51,'','','','',1,NULL,2),(54,NULL,NULL,NULL,NULL,1,NULL,2),(55,NULL,NULL,NULL,NULL,1,NULL,2);
...
INSERT INTO `estados` VALUES (1,'Acre','AC',1,1,1),(2,'Alagoas','AL',0,1,1),(3,'Amapá','AP',0,1,1),(4,'Amazonas','AM',0,1,1),(5,'Bahia','BA',0,1,1),(6,'Ceará','CE',1,1,1),(7,'Distrito Federal','DF',0,1,1),(8,'Espírito Santo','ES',0,1,1),(9,'Goiás','GO',0,1,1),(10,'Maranhão','MA',0,1,1),(11,'Mato Grosso','MT',0,1,1),(12,'Mato Grosso do Sul','MS',0,1,1),(13,'Minas Gerais','MG',0,1,1),(14,'Pará','PA',0,1,1),(15,'Paraíba','PB',0,1,1),(16,'Paraná','PR',0,1,1),(17,'Pernambuco','PE',0,1,1),(18,'Piauí','PI',0,1,1),(19,'Rio de Janeiro','RJ',0,1,1),(20,'Rio Grande do Norte','RN',0,1,1),(21,'Rio Grande do Sul','RS',0,1,1),(22,'Rondônia','RO',0,1,1),(23,'Roraima','RR',0,1,1),(24,'Santa Catarina','SC',0,1,1),(25,'São Paulo','SP',0,1,1),(26,'Sergipe','SE',0,1,1),(27,'Tocantins','TO',0,1,1);
...
INSERT INTO `funcionarios` VALUES (24,'Funcionário','346.021.710-36','1','','2023-05-25',1,2,50,10),(25,'1','111.111.111-11','','',NULL,1,2,51,11);
...
INSERT INTO `grupos_permissoes` VALUES (1,17,2,1),(1,18,2,1),(1,19,2,1),(1,20,2,1),(1,21,2,1),(1,22,2,1),(1,23,2,1),(1,24,2,1),(1,25,2,1),(1,26,2,1),(1,27,2,1),(1,28,2,1),(1,29,2,1),(1,30,2,1),(1,31,2,1),(1,33,2,1),(1,34,2,1),(1,35,2,1),(1,36,2,1),(1,37,2,1),(1,38,2,1),(1,39,2,1),(1,40,2,1),(1,41,2,1),(2,17,2,1),(2,18,2,1),(2,19,2,1),(2,20,2,1),(3,18,2,1),(3,19,2,1),(3,20,2,1),(4,17,2,1),(4,18,2,1),(4,19,2,1),(4,20,2,1),(5,18,2,1),(5,19,2,1),(5,20,2,1),(5,24,2,1),(5,25,2,1),(5,37,2,1),(5,38,2,1),(5,39,2,1),(5,40,2,1);
...
INSERT INTO `parameter` VALUES (1,'nome_fantazia','','Nome como que todos conhecem',1,1),(2,'razao_social','','Nome como está no documento',1,1),(3,'titulo_site','','Nome para o site',1,1),(4,'icone_site','favicon.png','Imagem do Ícone do Site',1,1),(5,'email','paulistensetecnologia@zohomail.com','Email para envio automático',1,1),(6,'senha','@G182534','Senha do email para envio automático',1,1),(7,'endereco','1','Endereço do dono/empresa do sistema',1,1),(8,'sobre_titulo','Sobre','',1,1),(9,'contato_titulo','Contato','',1,1),(10,'contato','1','Chave Estrangeira da tabela contatos',1,1),(11,'servicos_titulo','Serviços','Título da página de serviços',1,1),(12,'google_analytics','G-5ZS0PB48KT','Códifo do Google Analytics',1,1),(13,'servidor_email_smtp','smtp.zoho.com','Protocolo de E-mail',1,1),(14,'servidor_email_porta','587','Porta do Servidor de E-mail',1,1),(15,'servidor_email_seguranca','tls','Tipo da Segurança do Envio de E-mail',1,1),(16,'mostrar_error','1','Mostrar erros das páginas PHP',0,1),(17,'servidor_debug_email','1','MOSTRAR ERROR AO ENVIAR EMAIL',1,1),(18,'tempo_sessao_site','1800','Tempo de usuário ficar logado',1,1),(19,'autor_site','Geverson Souza','Quem criou o site',1,1),(20,'modulos_sistema','2','Módulo do sistema que está ativo/contratado',1,1),(21,'teste_ambiente_sistema','1','Teste ambiente sistema',1,1),(22,'landing_page','landing_page','landing_page',0,1);
...
INSERT INTO `usuarios` VALUES (1,'Administrator',NULL,'admin@admin.com','$2y$10$IfvfgkG1LLW2jwJKgDueHe6YwJEt5dtUHyru5f7L3.yKSQKuhotOy','2023-04-08 02:18:48',NULL,1,NULL),(2,'Geverson J de Souza',NULL,'geversonjosedesouza@gmail.com','$2y$10$EAW9YOmIdECWXAhAMUyP9uTitfcl0QRty2AlxeXcg0k2Vn1.plvUO','2023-05-10 15:43:04',NULL,1,NULL),(4,'Funcionário','346.021.710-36','funcionario@funcionario.com','$2y$10$EAW9YOmIdECWXAhAMUyP9uTitfcl0QRty2AlxeXcg0k2Vn1.plvUO',NULL,NULL,1,NULL),(5,'Usuário',NULL,'usuario@usuario.com','$2y$10$Swt.D3xgaLpawqOwX7FC7uvXg5FmsBnrh0/aMwIbNcgrGldBP6cTC',NULL,NULL,1,NULL),(6,'Colaborador',NULL,'colaborador@colaborador.com',NULL,NULL,NULL,1,NULL),(25,'1','111.111.111-11','1@1.com',NULL,NULL,NULL,1,NULL);
...
INSERT INTO `usuarios_grupos` VALUES (1,2,1,2),(2,1,1,2),(4,4,1,2),(5,5,1,2);
...
-- Dump completed on 2023-05-10 13:09:47
