...
CREATE TABLE `funcionarios` (
  ...
  KEY `fk_funcionarios_contato_id_idx` (`contato_id`),
  ...
  CONSTRAINT `fk_funcionarios_contato_id` FOREIGN KEY (`contato_id`) REFERENCES `contact` (`cont_pk_id`),
...
INSERT INTO `grupos` VALUES (1,'TI',1,2),(2,'Administrador',1,2),(3,'Usuário',1,2),(4,'Funcionário',1,2);
...
INSERT INTO `grupos_permissoes` VALUES (1,17,2,1),(1,18,2,1),(1,19,2,1),(1,20,2,1),(1,21,2,1),(1,22,2,1),(1,23,2,1),(1,24,2,1),(1,25,2,1),(1,26,2,1),(1,27,2,1),(1,28,2,1),(1,29,2,1),(1,30,2,1),(1,31,2,1),(1,33,2,1),(1,34,2,1),(1,35,2,1),(2,17,2,1),(2,18,2,1),(2,19,2,1),(2,20,2,1),(3,18,2,1),(3,19,2,1),(3,20,2,1),(4,17,2,1),(4,18,2,1),(4,19,2,1),(4,20,2,1);
...
-- Dump completed on 2023-04-23 16:32:23
