...
class ControllerMenuItem {
        ...
        if (HelperController::authotity()) {
            ...
            try {
                ...
                if (!isset($menuItem)) {
                    ...
                    include_once server_path('br/com/system/view/menu_item/edit.php');
                }
            } catch (Exception $erro) {
                $this->info = "error=" . $erro->getMessage();
            }
    ...
    public function listar() {
        if (HelperController::authotity()) {
            ...
            include_once server_path('br/com/system/view/menu_item/list.php');
        }
    }
    ...
    public function novo() {
        if (HelperController::authotity()) {
            $menus = $this->daoMenu->selectObjectsEnabled();
            $submenus = $this->daoMenuItem->selectObjectsEnabled();
            include_once server_path('br/com/system/view/menu_item/new.php');
        }
    }
