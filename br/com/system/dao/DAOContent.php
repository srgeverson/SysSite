...
class DAOContent extends GenericDAO {
    ...
    public function save(ModelContent $content = null) {
        ...
        $this->query .= "(conte_component, conte_title, conte_subtitle, conte_text, conte_image, conte_link, usuario_id, conte_fk_page_pk_id) ";
        $this->query .= "VALUES ";
        $this->query .= "(:conte_component, :conte_title, :conte_subtitle, :conte_text, :conte_image, :conte_link, :usuario_id, :conte_fk_page_pk_id);";
        try {
            $conexao = $this->getInstance();
        ...
        $this->statement->bindParam(':usuario_id', $content->usuario_id, PDO::PARAM_INT);
    ...
    public function selectObjectById($conte_pk_id = 0) {
        ...
        $this->query .= "INNER JOIN usuarios AS u ON (c.usuario_id = u.id) ";
