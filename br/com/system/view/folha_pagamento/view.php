...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        ...
        <?php
        //echo $folhaPagamento->fopa_arquivo;
        ?>
        <a href="<?php echo server_url('?page=ControllerFolhaPagamento&option=downloadFile&fopa_pk_id=' . $folhaPagamento->fopa_pk_id); ?>">Download</a>
    </div>
    <div class="col-lg-4 mb-4">
