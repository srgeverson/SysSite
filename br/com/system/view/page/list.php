...
<div class="card shadow mb-4">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4 mb-4 mb-sm-0">
                    <div class="input-group input-group-lg">
                        ...
                        <input class="form-control" type="text" name="page_description">
                    </div>
                </div>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <?php
            if (!isset($pages)) {
                echo '<h2>Use o filtro para ver as páginas cadastradas</h2>';
            } else {
                ...
                foreach ($pages as $each_page) {
                    ...
                    if ($each_page->page_status == true) {
                        ...
                        echo '<a title="Editar dados!" href="', server_url('?page=ControllerPage&option=edit&page_pk_id=' . $each_page->page_pk_id), '" class="btn btn-warning btn-circle btn-sm" style="margin: 5px">';
                        echo '<i class="fas fa-edit"></i>';
                        echo '</a>';
                        echo '<a title="Ativar dados!" href="', server_url('?page=ControllerPage&option=enable&page_pk_id=' . $each_page->page_pk_id), '" class="btn btn-success btn-circle btn-sm excluir" style="margin: 5px">';
                        echo '<i class="fas fa-check-circle"></i>';
                        echo '</a>';
                        echo '<a title="Excluir dados!" href="', server_url('?page=ControllerPage&option=delete&page_pk_id=' . $each_page->page_pk_id), '" class="btn btn-danger btn-circle btn-sm excluir" onclick="return confirm(´Deseja realmente excluir, esta operação não podera ser desfeita!´)" style="margin: 5px">';
