...
//            if (isset($each_contact->cont_link)) {
//                echo '<div class="col-lg-8 mb-4">';
//                echo '<iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="', $each_contact->cont_link, '"></iframe>';
//                echo '</div>';
//            }
            ...
            echo '<h3>', $each_contact->cont_title, '</h3>';
            echo '<p>', $each_contact->cont_text, '</p>';
            echo '<p>';
