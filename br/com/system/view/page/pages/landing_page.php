...
<div class="container">
    ...
    <?php
        ...
        echo '</div>';
        echo '<div class="row justify-content-center">';
        echo '<a class="btn btn-primary btn-lg m-3" style="border-radius:100rem;background-color:#2dd54d;border:0;" href="https://api.whatsapp.com/send?phone=', $contact->cont_whatsapp, '&text=', $contact->cont_whatsapp_msg, '"><i class="fab fa-whatsapp"></i> Whatsapp</a>';
        echo '</div>';
        echo '<div class="row justify-content-center">';
