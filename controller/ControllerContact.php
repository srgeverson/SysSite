...
class ControllerContact {
    ...
    public function edit() {
        if (HelperController::authotity()) {
            ...
            include_once server_path('view/contact/edit.php');
        }
    }
    ...
    public function listar() {
        if (HelperController::authotity()) {
            ...
            include_once server_path('view/contact/list.php');
        }
    }

    public function novo() {
        if (HelperController::authotity()) {
            include_once server_path('view/contact/new.php');
        }
    }
    ...
    public function submit() {
        ...
        try {
            if ($this->send_email($contact)) {
                ...
                include_once server_path('view/contact/success.php');
            } else {
