...
include_once server_path("model/ModelMenu.php");
include_once server_path("dao/DAOMenu.php");
include_once server_path("dao/DAOMenuItem.php");
include_once server_path("dao/DAOSistema.php");
...
class ControllerMenu {
        ...
        if (HelperController::authotity()) {
            ...
            try {
                ...
                if (!isset($menu)) {
                    ...
                    include_once server_path('view/menu/edit.php');
                }
            } catch (Exception $erro) {
                $this->info = "error=" . $erro->getMessage();
            }
    ...
    public function listar() {
        if (HelperController::authotity()) {
            ...
            include_once server_path('view/menu/list.php');
        }
    }
    ...
    public function novo() {
        if (HelperController::authotity()) {
            $sistemas = $this->daoSistema->selectObjectsEnabled();
            include_once server_path('view/menu/new.php');
        }
    }
