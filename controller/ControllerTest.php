...
include_once server_path("dao/DAOTest.php");
include_once server_path("model/ModelParameter.php");
include_once server_path("model/ModelTest.php");
...
class ControllerTest {
        ...
        if (HelperController::authotity()) {
            ...
            if (!isset($test_id)) {
                ...
                if ($test->test_image != null || $test->test_image != '') {
                    unlink(server_path('uploads/test/' . $test->test_image));
                }
                try {
    ...
    public function edit() {
        if (HelperController::authotity()) {
            ...
            include_once server_path('view/test/edit.php');
        }
    }
    ...
    public function listar() {
        if (HelperController::authotity()) {
            ...
            include_once server_path('view/test/list.php');
        }
    }

    public function new() {
        if (HelperController::authotity()) {
            include_once server_path('view/test/new.php');
        }
    }

    public function new_ajax() {
        if (HelperController::authotity()) {
            include_once server_path('view/test/new_ajax.php');
        }
    }
    ...
    public function uploadImagem(){
        ...
        if (isset($arquivo) && isset($nome_arquivo) ){
            ...
            $uploaddir = server_path('uploads/test/');;
