...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <form action="<?php echo server_url('?page=ControllerContato&option=save'); ?>" method="post">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="telefone" id="phone" type="text" placeholder="Digite o telefone...">
                    </div>
                    <div class="form-group">
                        <label class="text-primary">Celular:</label><br>
                        <input class="form-control" name="celular" id="cell" type="text" placeholder="Digite o celular...">
                    </div>
                    <div class="form-group">
                        <label class="text-primary">Whatsapp:</label><br>
                        <input class="form-control" name="whatsapp" id="whatsapp" type="text" placeholder="Digite o whatsapp...">
                    </div>
                    <div class="form-group">
