            ...
            <div class="form-group row">
                <div class="col-sm-4 mb-4 mb-sm-0">
                    <div class="input-group input-group-lg">
                        ...
                        <input class="form-control" name="nome" placeholder="Digite o nome" type="text">
                    </div>
                </div>
                <div class="col-sm-4 mb-4 mb-sm-0">
                    <div class="input-group input-group-lg">
                        <span class="input-group-text">CPF</span>
                        <input class="form-control" id="cpf" name="cpf" placeholder="000.000.000-00"type="tel" value="<?php echo $user_logged->user_fk_permissao_pk_id == 3 ? $funcionario->cpf : ''; ?>" <?php echo $user_logged->user_fk_permissao_pk_id == 3 ? 'readonly' : ''; ?>>
                    </div>
                </div>
                <div class="col-sm-4 mb-4 mb-sm-0">
        ...
        <div class="table-responsive">
            ...
            if (!isset($folhaPagamentos)) {
                ...
                foreach ($folhaPagamentos as $each_folha_pagamentos) {
                    ...
                    echo '<td>', $each_folha_pagamentos->nome, '</td>';
                    echo '<td>', $each_folha_pagamentos->cpf, '</td>';
                    echo '<td>', $each_folha_pagamentos->fopa_competencia, '</td>';
                    $data = new DateTime($each_folha_pagamentos->data_nascimento);
