...
$(document).ready(function () {
    ...
    $("select[name='usuario_id[]']").change(function(e){
        $("button[name='adicionar_usuario']").prop('disabled', $("select[name='usuario_id[]']").find(":selected").val() === undefined);
    });
...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <form action="<?php echo server_url('?page=ControllerGrupo&option=adicionarUsuarios'); ?>" method="post">
            <div class="card h-100">
                <h4 class="card-header text-primary">Vincular Usuário a Grupo</h4>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="text-primary">Usuários:</label><br>
                        <select name="usuario_id[]" class="form-control selectpicker" multiple data-actions-box="true" data-live-search="true" required>
                        </select>
                    </div>
                </div>
