...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <form action="<?php echo server_url('?page=ControllerMenuItem&option=save'); ?>" method="post">
            <div class="card h-100">
                <h4 class="card-header text-primary">Cadastrar Item de Menu</h4>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="titulo" type="text" placeholder="Digite um título...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="menu_id" class="form-control" required>
                            ...
                            foreach ($menus as $each_menu) {
                                echo '<option value="', $each_menu->id, '"', '>', $each_menu->nome, '</option>';
                            }
                            ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="text-primary">SubMenu:</label><br>
                        <select name="menu_item_id" class="form-control">
                            <option></option>
                            <?php
                            foreach ($submenus as $each_menu) {
                                echo '<option value="', $each_menu->id, '"', '>', $each_menu->nome, '</option>';
                            }
                            ?>
                        </select>
