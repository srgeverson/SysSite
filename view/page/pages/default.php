...
<header>
    ...
    if (count($slide_apresentacao)) {
        if (count($slide_apresentacao)) {
            ...
            $i = 0;
            foreach ($slide_apresentacao as $each_slide_apresentacao) {
                echo '<div class="carousel-item ', $i == 0 ? 'active' : '', '" style="background-image: url(', isset($each_slide_apresentacao->conte_image) ? server_url('uploads/content/' . $each_slide_apresentacao->conte_image) : server_url('assets/img/1900x1080.png'), '">';
        ...
        foreach ($nossos_destaques as $each_nossos_destaques) {
            echo '<div class="col-lg-4 col-sm-6 portfolio-item">';
                    echo '<div class="card h-100">';
                            echo '<a href="#"><img class="card-img-top" src="', isset($each_nossos_destaques->conte_image) ? server_url('uploads/content/' . $each_nossos_destaques->conte_image) : server_url('assets/img/700x400.png'), '" alt="' . $each_nossos_destaques->conte_image . '"></a>';
