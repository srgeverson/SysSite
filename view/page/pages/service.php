...
<div class="container">
    ...
    if (count($destaques_servicos)) {
        foreach ($destaques_servicos as $each_destaques_servicos) {
            echo '<img class="img-fluid rounded mb-4" src="', isset($each_destaques_servicos->conte_image) ? server_url('uploads/content/' . $each_destaques_servicos->conte_image) : server_url('assets/img/1200x300.png'), '" alt = "', $each_destaques_servicos->conte_title, '" alt="', $each_destaques_servicos->conte_title, '">';
        }
    }
    ?>
