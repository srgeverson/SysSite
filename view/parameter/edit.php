            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="para_value" type="text" placeholder="Digite um valor..." value="<?php echo $parameter->para_value; ?>">
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer">
                    <div class="btn-toolbar justify-content-between" role="toolbar" aria-label="Toolbar com grupos de botões">
                        ...
                        <div class="input-group">
                            <a  class="btn btn-danger btn-icon-split" href="<?php echo server_url('?page=ControllerParameter&option=listar'); ?>" type="submit">
                                <span class="icon text-white-50">
