...
<html lang="pt-br">
    <head>
        ...
        <?php
            ...
            echo '</title>';
            //Icone da página
            echo '<link rel="icon" href="', $icone != 'Vazio/Desabilitado' ? server_url('uploads/parameter/') . $icone : '', '">';
        ?>
        ...
        <!-- datapiker CSS -->
        <link href="<?php echo server_url('assets/vendor/bootstrap/datepicker/css/') . 'datepicker.css'; ?>" rel="stylesheet" type="text/css">
